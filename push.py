...
from status import get_push_status

def handle_options_push(cmd_parser):
    ...
    cmd_parser.add_argument('-d','--description',
                          nargs=1,
                          dest='description',
                          help='Enter the description of project')

    cmd_parser.set_defaults(func=push)
